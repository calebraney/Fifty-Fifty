(() => {
  ...
  var checkBreakpoints2 = function(item2, animationID, gsapContext) {
  ...
  var accordion = function(gsapContext) {
    ...
    accordionLists.forEach((list) => {
      let runOnBreakpoint = checkBreakpoints2(list, ANIMATION_ID, gsapContext);
  ...
  var countUp = function(gsapContext) {
    ...
    items.forEach((item2) => {
      ...
      let runOnBreakpoint = checkBreakpoints2(item2, ANIMATION_ID, gsapContext);
      if (runOnBreakpoint === false) return;
  ...
  var horizontal = function(gsapContext) {
    ...
    sections.forEach((section) => {
      ...
      let runOnBreakpoint = checkBreakpoints2(wrap, ANIMATION_ID, gsapContext);
      if (runOnBreakpoint === false) return;
  ...
  var parallax = function(gsapContext) {
    ...
    parallaxItems.forEach((parallaxItem) => {
      ...
      let runOnBreakpoint = checkBreakpoints2(parallaxItem, ANIMATION_ID, gsapContext);
      if (runOnBreakpoint === false) return;
      const settings = {
        scrub: true,
        start: "top bottom",
